...
<nav aria-label="Primary navigation" class="nav"><a href="/">Home</a><a href="/services/">Services</a><div class="dropdown"><button aria-expanded="false" aria-haspopup="true" type="button">Education <span>▾</span></button><div class="dropdown-panel"><a href="/education/colleges-universities/">Colleges &amp; Universities</a><a href="/education/academic-courses/">Academic Courses</a><a href="/education/career-guidance/">Career Guidance</a><a href="/education/skill-courses/">Skill Courses</a><a href="/education/study-abroad-guide/">Study Abroad Guide</a><a href="/education/">Education home</a></div></div><a class="${blogActive}" href="/blog/">Blog</a><a href="/about/">About</a><a href="/contact/">Contact</a><a class="btn btn-primary header-cta" href="/contact/">Let's talk ↗</a></nav><button aria-expanded="false" aria-label="Open menu" class="menu-btn" type="button">Menu</button></div><div class="mobile-nav container"><a href="/">Home</a><a href="/services/">Services</a><div class="mobile-education"><button class="mobile-education-toggle" type="button" aria-expanded="false">Education <span>▾</span></button><div class="mobile-sub"><a href="/education/colleges-universities/">Colleges &amp; Universities</a><a href="/education/academic-courses/">Academic Courses</a><a href="/education/career-guidance/">Career Guidance</a><a href="/education/skill-courses/">Skill Courses</a><a href="/education/study-abroad-guide/">Study Abroad Guide</a><a href="/education/">Education home</a></div></div><a href="/blog/">Blog</a><a href="/about/">About</a><a href="/contact/">Contact</a></div></header>`;
}
...
const educationHomeSections=['Colleges & Universities','Academic Courses','Career Guidance','Skill Courses','Study Abroad Guide'];
const educationHomeItems=educationHomeSections.map(section=>educationItems.find(item=>String(item.section||'').trim()===section)).filter(Boolean);
replaceMarker(eduHome,'<!-- CMS_EDU_HOME:START -->','<!-- CMS_EDU_HOME:END -->',educationHomeItems.map(itemCard).join('\n'));
...
replaceMarker(path.join(ROOT,'education','colleges-universities','index.html'),'<!-- CMS_EDU_ITEMS_PLUS2_COLLEGES:START -->','<!-- CMS_EDU_ITEMS_PLUS2_COLLEGES:END -->',educationItemsFor('Colleges & Universities','+2 college / institution').map(itemCard).join('\n'));
